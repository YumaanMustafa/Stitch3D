...
/**
 * @file page.js
 * @description Vendor Profile - Simplified Text & Modern Light Theme.
 */
...
export default function VendorProfile() {
  const [initialValues, setInitialValues] = useState({
    name: "Stitch Studio",
    email: "vendor@stitch.com",
    company: "Stitch Designs",
  });
    ...
    <div className="space-y-12 pb-20 animate-fade-in max-w-4xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
           ...
           <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase italic">My Profile</h1>
           <p className="text-sm font-medium text-slate-500 mt-2">Manage your public vendor identity and store details.</p>
        </div>
      </div>
            ...
            <Form className="space-y-8">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-2">
                     <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest px-1">Vendor Name</label>
