...
/**
 * @file page.js
 * @description Vendor Settings - Simplified Text & Modern Light Theme.
 */
    ...
    <div className="space-y-12 pb-20 animate-fade-in max-w-4xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
           ...
           <h1 className="text-4xl font-black text-slate-900 tracking-tighter uppercase italic">My Account</h1>
           <p className="text-sm font-medium text-slate-500 mt-2">Manage your profile and security settings.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8">
         ...
         <section className="bg-white rounded-[2.5rem] border border-slate-200 p-10 shadow-xl shadow-slate-200/40">
            <div className="flex items-center justify-between mb-10">
               <div className="flex items-center gap-4">
                  ...
                  <div>
                     <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Personal Info</h3>
                     <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Edit your name and profile</p>
                  </div>
               </div>
               {!isNameEditing && (
         ...
         <section className="bg-rose-50 rounded-[2.5rem] border border-rose-100 p-10">
            ...
            <p className="text-[11px] font-medium text-rose-700 leading-relaxed max-w-xl mb-8">Permanently delete your account. This action cannot be undone once the 72-hour grace period is over.</p>
